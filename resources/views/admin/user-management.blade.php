...
<h3 class="page-title">SYSTEM USERS</h3>
    ...
    <div class="row row-add-user d-flex flex-row-reverse">
        <button type="button" class="btn btn-add-user" data-bs-toggle="modal" data-bs-target="#category">Add New user</button>
    </div>
    <div class="row p-3">
            ...
            @foreach($users as $user)
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <button type="button" class="btn btn-upd-user" data-bs-toggle="modal" data-bs-target="#enable-category-modal{{ $user->id }}"><i class="bi bi-x-circle-fill"></i></button>
                        @endif
            ...
            <form id="registration-form" method ="POST" action="/admin/store-user">
                ...
                <div class="modal-body">
                    <div>
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" id="contactfield" name="mobile" placeholder="Contact (09)" onkeyup=" return validatephone(this.value); " required>
                            </div>
