<div class="d-flex" id="wrapper">
            ...
            <div class="border-end" id="sidebar-wrapper">
                <div class="sidebar-heading border-bottom" style="color: #fff; font-weight: bold; letter-spacing: 5px;">BITS&BYTES</div>
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{url('admin')}}"><i class="bi bi-bar-chart-line-fill">&nbsp;</i>Dashboard</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{url('admin/monthly')}}"><i class="bi bi-calendar-event-fill">&nbsp;</i>Monthly Sales</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{url('admin/stocks')}}"><i class="bi bi-box">&nbsp;</i>Stocks</a>
                ...
                @if(Auth::user()->isManager())
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{url('manager/return')}}"><i class="bi bi-cart-fill">&nbsp;</i>Returned Items</a>
                @endif
                </div>
            </div>
