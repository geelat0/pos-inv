                ...
                <div class="container-fluid">
                    ...
                    <div class="card m-4">
                        <div class="card-body">
                            ...
                            <form action="/manager/add-stocks" method="post">
                                @csrf
                                @method('post')
        ...
        <div class="modal" id="restock">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <div>
                    <form id="new-category" method="post" action='/manager/restocks'>
                        @csrf
                        @method('post')
                        <div class="mb-3">
        ...
        @foreach($items as $item)
            <div class="modal" id="update-item{{ $item->id }}">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <div>
                        <form id="new-category" action="/manager/update_item" method="post">
                        @csrf
                        @method('post')
            ...
            <div class="modal" id="enable-stock-modal{{ $item->id }}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!-- Modal Footer (optional) -->
                        <form method="post" action="/manager/stock-status">
                            @csrf
