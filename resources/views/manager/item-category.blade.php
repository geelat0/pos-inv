    ...
    <body>
        ...
        <div class="modal" id="category">
            <div class="modal-dialog">
                ...
                <!-- Modal Body -->
                <form id="new-category" method ="POST" action="/manager/store-category">
                @csrf
                @method('post')
        ...
        @foreach ($categories as $item )
            <div class="modal" id="upd-category{{ $item->id }}">
                <div class="modal-dialog">
                    ...
                    <!-- Modal Body -->
                    <form id="new-category" method="post" action="/manager/update_category">
                    @csrf
                        <div class="modal-body">
                            <div>
                                <div class="mb-3">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!-- Modal Body -->
                            ...
                            <!-- Modal Footer (optional) -->
                            <form method="post" action="/manager/category-status">
                            @csrf
