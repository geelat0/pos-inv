        ...
        <div class="modal" id="supplier">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <div>
                    <form id="new-category" action="/manager/store-supplier" method="post">
                    @csrf
                    @method('post')
                        <div class="mb-3">
        ...
        @foreach ($suppliers as $item )
            <div class="modal" id="upd-supplier{{ $item->id }}">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <div>
                        <form id="new-category" method="post" action="/manager/update_supplier">
                        @csrf
            ...
            <div class="modal" id="enable-supplier-modal{{ $item->id }}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!-- Modal Footer (optional) -->
                        <form method="post" action="/manager/supplier-status">
                            @csrf
