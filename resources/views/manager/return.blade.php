        ...
        @include('includes.page-wrapper')
                ...
                <div class="container-fluid">
                    ...
                    <div style="margin-top: 3%;">
                        <div class="row">
                            <h3 class="page-title" >RETURN GROUNDS</h3>
                        </div>
                        <div class="row">
                            <div class="col">
        ...
        <div class="modal" id="return-item">
            <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <!-- Modal Body -->
                <form id="" action="/manager/add-return" method="post">
                @csrf
                @method('post')
        ...
        <div class="modal" id="add-return-ground">
            <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <!-- Modal Body -->
                <form id="" action = "/manager/add-grounds" method="post">
                @csrf
                @method('post')
                  <div class="modal-body">
                      <div>
            ...
            <div class="modal" id="remove{{ $item->id }}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form method="post" action="/manager/remove">
                            @csrf
